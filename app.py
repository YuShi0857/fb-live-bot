    ...
    if not product_name and uploaded_file is None:
        ...
        with st.spinner("AI 靈感湧現中，請稍候... (若數量較多請耐心等待)"):
            try:
                ...
                6. 留言者人設 (極重要)：請將這 {num_comments} 則留言，分配給以下這些不同身分的買家來發言：【{persona_instruction}】。請生動地模仿這些族群各自的口吻與關注點。**特別注意：若是「通用 (不分性別年齡，最百搭)」人設，請確保用語絕對中性，嚴禁在留言中提及特定性別、年齡或家庭身分，必須是男女老少說出來都合理的句子。**
